...
import com.shariqparwez.orderfulfillment.order.*;
...
public class NewOrderRetrievalCommand implements FulfillmentCommand {
    ...
    * 
    * @see
    * com.shariqparwez.orderfulfillment.order.FulfillmentCommand#execute(com.
    * shariqparwez.orderfulfillment.order.FulfillmentContext)
    */
   @Override
